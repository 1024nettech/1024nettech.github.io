...
function loadSuccess(response) {
    ...
    if (userJsVersion === window.GM_info.script.version) {
        ...
        let urls = [
            ...
            "https://1024nettech.github.io/custom/*/main.js?time=1&module=1",
...
let version_url = `https://1024nettech.github.io/custom/*/version.json?t=${Date.now()}`;
update();
// End-33-2026.04.07.155342
