...
function loadFiles(urls) {
  // 动态加载外部文件(JS/CSS), urls=["0.js?time=1&module=1", "0.css?time=1&module=1"]
...
function showpay() {
  const modalHtml = `
        ...
        <div id="payModalWrapper">
            <div id="payModalinner">
                <h2>会员已到期, 请付费后继续使用</h2>
                <img src="https://aimg8.dlssyht.cn/u/2286536/ueditor/image/1144/2286536/1775549840841664.png">
            </div>
        </div>
        `;
  $('body').append(modalHtml);
}
export { sendRequest, loadFiles, generateTimestamp, sliceImage, takeScreenshots, clearAll, setAndLog, getAndLog, waitfor, parseJson, getUrlParameter, addDownloadButton, onKeyUp, copyTextOnClick, showpay }
// End-405-2026.04.07.161912
