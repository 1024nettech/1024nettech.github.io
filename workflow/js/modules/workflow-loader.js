...
function loadSucess(response) {
    ...
    if (userJsVersion === window.GM_info.script.version) {
        ...
        let urls = [
            ...
            "https://1024nettech.github.io/workflow/js/modules/workflow-main.js?time=1&module=1",
            "https://1024nettech.github.io/workflow/css/workflow-public.css?time=0&module=0"
        ];
        ...
        let urls = ["https://1024nettech.github.io/workflow/css/workflow-public.css?time=0&module=0"];
        publics.loadFiles(urls);
        let html = `
            <a id="update_tip" href="https://1024nettech.github.io/workflow/js/workflow.user.js" target="_blank">点这里,弹出新窗口,按图1点击,刷新此页面,如果弹出图2的窗口,按图2点击,不弹不用点</a>
            <br>
...
let version_url = `https://1024nettech.github.io/workflow/js/version.json?t=${Date.now()}`;
update();
// End-50-2025.08.11.105203