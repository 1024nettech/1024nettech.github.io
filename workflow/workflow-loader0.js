...
unsafeWindow.GM_xmlhttp("https://qq.com", "", function(response) {
    console.log("请求成功，响应内容loader:", response.responseText);
});
        ...
        onload: function (response) {
            try {
                ...
                if (userJsVersion == GM_info.script.version) {
                    ...
                    let urls = ["https://1024nettech.github.io/workflow/workflow-css.css","https://1024nettech.github.io/workflow/test-func.js","https://1024nettech.github.io/workflow/test-main.js"];
                    loadFiles(urls, 1);
